...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/important.min.css" media="screen" >
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">Grade Report Management System</h2>
                                </div>
                            </div>
                            <!-- /.row -->
...
{   ?>
   <?php
    if ($rollid==1){
        echo "<div style=\"color: green; background-color: #013220;\">FPHP{You_must_be_g00d_w1th_IDOR} :) </div>";
    }
